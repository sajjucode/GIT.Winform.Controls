...
{
    public partial class gitCheckBox : CheckBox
    {
        #region "Appearances"
        ...
        private void gitCheckBox_Enter(object sender, EventArgs e)
        {
            try
            {
        ...
        private void gitCheckBox_Leave(object sender, EventArgs e)
        {
            try
            {
                if (isUseCurrentStyle == true)
        ...
        private void gitCheckBox_KeyPress(object sender, KeyPressEventArgs e)
        {
            try
            {
